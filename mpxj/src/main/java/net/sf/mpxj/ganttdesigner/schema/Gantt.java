...
}) @XmlRootElement(name = "Gantt") public class Gantt
{
   ...
   @XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") public static class Calendar
   {
      ...
      @XmlAttribute(name = "WeekStart") @XmlJavaTypeAdapter(Adapter5.class) protected Day weekStart;
   ...
   }) public static class Columns
   {
      ...
      public List<Gantt.Columns.Header> getHeader()
      {
         if (header == null)
         {
            header = new ArrayList<Gantt.Columns.Header>();
         }
         return this.header;
      }
   ...
   @XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") public static class Copy
   {
      ...
      @XmlAttribute(name = "fromDate") @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "date") protected Date fromDate;
      @XmlAttribute(name = "toDate") @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "date") protected Date toDate;
   ...
   }) public static class DateHeader
   {
      ...
      public List<Gantt.DateHeader.Tier> getTier()
      {
         if (tier == null)
         {
            tier = new ArrayList<Gantt.DateHeader.Tier>();
         }
         return this.tier;
      }
      ...
      @XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") public static class Reference
      {
         ...
         @XmlAttribute(name = "value") @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "date") protected Date value;
   ...
   @XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") public static class File
   {
      ...
      @XmlAttribute(name = "Saved") @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date saved;
      @XmlAttribute(name = "Created") @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date created;
       ...
       *     
       */
      public void setSaved(Date value)
      {
         this.saved = value;
      }
   ...
   @XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") public static class FirstDay
   {
      ...
      @XmlAttribute(name = "Date") @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "date") protected Date date;
   ...
   }) public static class FootersFonts
   {
      ...
      public List<Gantt.FootersFonts.Font> getFont()
      {
         if (font == null)
         {
            font = new ArrayList<Gantt.FootersFonts.Font>();
         }
         return this.font;
      }
   ...
   }) public static class HeadersFonts
   {
      ...
      public List<Gantt.HeadersFonts.Font> getFont()
      {
         if (font == null)
         {
            font = new ArrayList<Gantt.HeadersFonts.Font>();
         }
         return this.font;
      }
   ...
   }) public static class Holidays
   {
      ...
      public List<Gantt.Holidays.Holiday> getHoliday()
      {
         if (holiday == null)
         {
            holiday = new ArrayList<Gantt.Holidays.Holiday>();
         }
         return this.holiday;
      }
   ...
   }) public static class Tasks
   {
      ...
      public List<Gantt.Tasks.Task> getTask()
      {
         if (task == null)
         {
            task = new ArrayList<Gantt.Tasks.Task>();
         }
         return this.task;
      }
      ...
      }) public static class Task
      {
         ...
         @XmlAttribute(name = "S") @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "date") protected Date s;
         @XmlAttribute(name = "B") protected Integer b;
         @XmlAttribute(name = "BC") protected Integer bc;
         @XmlAttribute(name = "D") @XmlJavaTypeAdapter(Adapter4.class) protected Duration d;
         ...
         @XmlAttribute(name = "PC") @XmlJavaTypeAdapter(Adapter3.class) protected Double pc;
         @XmlAttribute(name = "DL") @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "date") protected Date dl;
         @XmlAttribute(name = "P") protected String p;
         @XmlAttribute(name = "L") @XmlJavaTypeAdapter(Adapter4.class) protected Duration l;
   ...
   }) public static class TextStyles
   {
      ...
      public List<Gantt.TextStyles.Font> getFont()
      {
         if (font == null)
         {
            font = new ArrayList<Gantt.TextStyles.Font>();
         }
         return this.font;
      }
